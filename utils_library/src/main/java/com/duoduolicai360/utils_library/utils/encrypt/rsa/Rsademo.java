package com.duoduolicai360.utils_library.utils.encrypt.rsa;
...
public class Rsademo {
	public static void main(String[] args) {
		try {
			...
			String enBaseDate = RsaHelper.encode(encodedData);
			System.out.println("加密后：\r\n" + enBaseDate);
			// byte[] decryptByPublicKey = RSACrypt.decryptByPublicKey(encodedData, publicKey);
			byte[] decryptByPublicKey = RsaHelper.decryptByPrivateKey(encodedData, privateKey);
